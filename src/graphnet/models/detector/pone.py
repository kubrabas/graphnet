...
class PONE(Detector):   
    ...
    def _charge(self, x):     return self._robust_scale(x, "charge")
    def _dom_time(self, x):   return self._robust_scale(x, "dom_time")
    def _dom_x(self, x):      return self._robust_scale(x, "dom_x")
    def _dom_y(self, x):      return self._robust_scale(x, "dom_y")
    def _dom_z(self, x):      return self._robust_scale(x, "dom_z")
    def _string(self, x):     return self._robust_scale(x, "string")
    def _pmt_number(self, x): return self._robust_scale(x, "pmt_number")
    def _dom_number(self, x): return self._robust_scale(x, "dom_number")
    def _pmt_x(self, x):      return self._robust_scale(x, "pmt_x")
    def _pmt_y(self, x):      return self._robust_scale(x, "pmt_y")
    def _pmt_z(self, x):      return self._robust_scale(x, "pmt_z")
