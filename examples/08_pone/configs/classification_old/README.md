...
```text
/project/def-nahee/kbas/Graphnet-Applications/Results/340StringMC/102_string_emax1e6/classification/category1_isMuonCC/exp001/train_and_val
/project/def-nahee/kbas/Graphnet-Applications/Results/340StringMC/102_string_emax1e6/classification/category2_tauCC_others_muonCC/exp002/train_and_val
/project/def-nahee/kbas/Graphnet-Applications/Results/340StringMC/full_geometry_emax1e6/classification/category1_isMuonCC/exp003/train_and_val
/project/def-nahee/kbas/Graphnet-Applications/Results/340StringMC/full_geometry_emax1e6/classification/category2_tauCC_others_muonCC/exp004/train_and_val
```
...
| --- | --- | --- | --- | --- |
| `exp001.yml` | `102_string_emax1e6` | `category1_isMuonCC` | binary | `classification/category1_isMuonCC/exp001` |
| `exp002.yml` | `102_string_emax1e6` | `category2_tauCC_others_muonCC` | multiclass | `classification/category2_tauCC_others_muonCC/exp002` |
| `exp003.yml` | `full_geometry_emax1e6` | `category1_isMuonCC` | binary | `classification/category1_isMuonCC/exp003` |
| `exp004.yml` | `full_geometry_emax1e6` | `category2_tauCC_others_muonCC` | multiclass | `classification/category2_tauCC_others_muonCC/exp004` |
